...
\include{sections/inledning}
\include{sections/bakgrund}
\include{sections/fragestallning}
\include{sections/metod}
\include{sections/etik}
\include{sections/utforande}
\include{sections/resultat}
\include{sections/diskussion}
\include{sections/relaterat_arbete}
\include{sections/slutsatser}
\include{sections/framtida_arbete}
\include{sections/referenser}
\include{sections/bilagor}
