...
Den latenta representation kan sedan användas i efterföljande diffusionsprocess som iterativt lägger till och avlägsnar brus för att generera nya bilder. Denna process sker helt i detta komprimerade latenta rum. När processen är klar avkodar VAE:ns decoder den latenta representationen tillbaka till en fullupplöst RGB-bild igen.
