...
Vi arbetar efter en kvantitativ experimentell design där vi samlar in och analyserar data från utförda experiment. Experimenten utgår från en baseline PNG-bild som sedan omvandlas med modellen. Vi studerar först effekten av kvantisieringen som är en traditionell komprimeringsmetod i sig själv. Därefter studerar vi effekter av komprimering med lossless och lossy (i tre kvalitetssteg)  genom JPEG XL. Vi studerar filstorleken och kvaliten efter rekonstruktion med PSNR och SSIM. <<SKA VI ANVÄNDA BPP?>>%och LPIPS.
\begin{figure}[H] 
    \centering
