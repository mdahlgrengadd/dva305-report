...
komprimeringsmetoder. Nedan redovisas dels ett sammandrag med medelvärden
per metod, dels detaljerade PSNR-värden för varje enskild bild.
...
\begin{table}[h]
\centering
\caption{Medelvärden per komprimerings\-strategi för samtliga 24 Kodak-bilder.}
\label{tab:summary}
\begin{tabular}{lrrrr}
\hline
\textbf{Metod} & \textbf{PSNR (dB)} & \boldmath$\Delta$\textbf{PSNR} & \textbf{SSIM} & \textbf{BPP} \\
\hline
NPZ               & 27{,}09 & ---      & 0{,}760 & 0{,}417 \\
