...
I våra experiment används dock enabart VAE-komponenten fristående från diffusionsprocessen och experimenten genomförs på ett öppet och etablerat bilddataset utan värdering av innehållet i bilderna. Däremot kan det finnas risk att bilder som förekommit oftare under träning leder till stabilare latent och därför möjligtvis mindre risk för kollaps vid rekonstruktion. Detta är högst osannolik hypotes och ingenting vi testat under våra experiment. Sammantaget bedöms forskningsetiska riskerna som små.
